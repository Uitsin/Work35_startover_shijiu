...
#include "string.h"
#include "math.h"
#include "bond_rock_channel_atom2.h"
#include "group.h"
#include "modify.h"
#include "error.h"
#include "atom.h"
...
BondRockChannelAtom2::BondRockChannelAtom2(LAMMPS *lmp) : Pointers(lmp) {}

void BondRockChannelAtom2::command(int narg, char **arg)
{
...
/*------------------------------------------------------*/
int BondRockChannelAtom2::pack_comm(int n, int *list, double *buf,
...
void BondRockChannelAtom2::unpack_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int BondRockChannelAtom2::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void BondRockChannelAtom2::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
double BondRockChannelAtom2::memory_usage()
{
  int nmax = atom->nmax;

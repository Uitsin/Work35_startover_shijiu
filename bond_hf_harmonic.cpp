...
void BondHfHarmonic::compute(int eflag, int vflag)
{
  ...
  for (n = 0; n < nbondlist; n++) {
    ...
    k_parallel = k1[type];
    k_perp = k_parallel/(2*(1+global_poisson));
...
//Changed!!!!!!!      
	...
	f0[atom1][2] = 0.0;	
       ...
       } //end of if of determining boundary

      /*
      if ( (x0[atom1][0]==9) && (x0[atom1][1]==102) && (x0[atom1][2]==4) && (x0[atom2][0]==9) && (x0[atom2][1]==101) && (x0[atom2][2]==4) ){
   	      FOOX = fsum_x;
	      FOOY = fsum_y;
	      FOOZ = fsum_z;
      }
	 ...
	 f0[atom2][2] = 0.0;
       ...
       } // end of if of determining boundary atoms of atom2
...
//Changed!!!!!!!      
    ...
    } // end of if of ntimestep > 0

        
    if (evflag) ev_tally(atom1,atom2,nlocal,newton_bond,ebond,fbond,delx,dely,delz);

  } // end of for loop of nbondlist

  
  for (n = 0; n<atom->nmax;n++){

    if ( (x0[n][0]==global_xlo) || (x0[n][0]==global_xhi) || (x0[n][1]==global_ylo) || (x0[n][1]==global_yhi) || (x0[n][2]==global_zlo) || (x0[n][2]==global_zhi) ) {      
    ...
    } // end of if of finding boundary atoms

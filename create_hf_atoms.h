...
CommandStyle(create_hf_atoms,CreateHfAtoms)

#else

#ifndef LMP_CREATE_HF_ATOMS_H
#define LMP_CREATE_HF_ATOMS_H

#include "pointers.h"

namespace LAMMPS_NS {

class CreateHfAtoms : protected Pointers {
 public:
  CreateHfAtoms(class LAMMPS *);

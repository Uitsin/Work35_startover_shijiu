...
DumpStyle(chlocal,DumpChLocal)

#else

#ifndef LMP_DUMP_CH_LOCAL_H
#define LMP_DUMP_CH_LOCAL_H

#include "dump.h"

namespace LAMMPS_NS {

class DumpChLocal : public Dump {
 public:
  DumpChLocal(LAMMPS *, int, char **);
  ~DumpChLocal();
 ...
 private:
  ...
  typedef void (DumpChLocal::*FnPtrPack)(int);

...
DumpStyle(hfimage2,DumpHfImage2)

#else

#ifndef LMP_DUMP_HF_IMAGE2_H
#define LMP_DUMP_HF_IMAGE2_H

#include "dump_custom.h"

namespace LAMMPS_NS {

class DumpHfImage2 : public DumpCustom {
 public:
  int multifile_override;          // used by write_dump command

  DumpHfImage2(class LAMMPS *, int, char**);
  virtual ~DumpHfImage2();

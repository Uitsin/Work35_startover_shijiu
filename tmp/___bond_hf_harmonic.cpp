...
void BondHfHarmonic::compute(int eflag, int vflag)
{
  ...
  ///////////////////  
  //  double BC_xlo = FixLubricationUpdateBC.BC_xlo;  /////////////////////////
  // double BC_xhi = FixLubricationUpdateBC::BC_xhi;
  //double BC_ylo = FixLubricationUpdateBC::BC_ylo;
  //double BC_yhi = FixLubricationUpdateBC::BC_yhi;
  //double BC_zlo = FixLubricationUpdateBC::BC_zlo;
  //double BC_zhi = FixLubricationUpdateBC::BC_zhi;

...
BondChannelAtom::BondChannelAtom(LAMMPS *lmp) : Pointers(lmp) {}

void BondChannelAtom::command(int narg, char **arg)
{
...
int * BondChannelAtom::sort(int *s, int n){

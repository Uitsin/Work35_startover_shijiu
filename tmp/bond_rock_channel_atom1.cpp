...
#include "string.h"
#include "math.h"
#include "bond_rock_channel_atom1.h"
#include "group.h"
#include "modify.h"
#include "error.h"
#include "atom.h"
...
BondRockChannelAtom1::BondRockChannelAtom1(LAMMPS *lmp) : Pointers(lmp) {}

void BondRockChannelAtom1::command(int narg, char **arg)
{
...
/*
int BondRockChannelAtom1::pack_comm(int n, int *list, double *buf,
...
void BondRockChannelAtom1::unpack_comm(int n, int first, double *buf)
{
  int i,m,last;
...
int BondRockChannelAtom1::pack_reverse_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void BondRockChannelAtom1::unpack_reverse_comm(int n, int *list, double *buf)
{
  int i,j,m;
...
double BondRockChannelAtom1::memory_usage()
{
  int nmax = atom->nmax;
...
int * BondRockChannelAtom1::sort(int *s, int n){

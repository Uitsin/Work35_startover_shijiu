  ...
  */
  for (n = 0; n < nlocal; n++){
    ...
    */
    ...
    xtemp = cos(angle) * xxx + sin(angle) * zzz;
    ztemp = -1*sin(angle) * xxx + cos(angle) * zzz;
    ...
    xtemp = cos(angle) * xxx - sin(angle) * zzz;
    ztemp = sin(angle) * xxx + cos(angle) * zzz;
    ...
    } // end of if(x[n][0] <= mix_start)

  } // end of for(n = 0; n < nlocal; n++)
